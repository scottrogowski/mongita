...
import mongita
from mongita import (MongitaClientSqlite, ASCENDING, DESCENDING,
...
_MongitaClientSqlite = functools.partial(MongitaClientSqlite, TEST_DIR)
LEN_TEST_DOCS = len(TEST_DOCS)
# CLIENTS = (MongitaClientMemory, _MongitaClientDisk)
CLIENTS = (_MongitaClientSqlite,)
...
def test_find_one(client_class):
    ...
    from pprint import pprint; pprint(list(coll.find({})))
